...
int main() {
	...
	{
		cout << "Numero de personas no valido." << endl << "Ingrese la cantidad de personas (0 a 10.000.000): ";
		cin >> numPersonas;
		cout << endl;
	}
	...
	{
		cout << "Porcentaje de la potencia de virus no valido" << endl << "Ingrese el porcentaje de la potencia del virus (0 a 99): ";
		cin >> potenciaVirus;
		cout << endl;
	}
	...
	{
		cout << "Porcentaje de la de la probabilidad de recuperacion no valido" << endl << "Ingrese el porcentaje de la probabilidad de recuperacion (0 a 99): ";
		cin >> probRecuperacion;
		cout << endl;
	}
	...
	{
		cout << "Porcentaje de la de la probabilidad de muerte no valido" << endl << "Ingrese el porcentaje de la probabilidad de muerte (0 a 99): ";
		cin >> probMuerte;
		cout << endl;
	}
	...
	{
		cout << "Porcentaje de personas infectadas inicialmente no valido" << endl << "Ingrese el porcentaje de personas infectadas inicialmente (0 a 99): ";
		cin >> porcentajeIntectados;
		cout << endl;
	}
	...
	{
		cout << "Tamaño del mundo no valido" << endl << "Ingrese el tamaño del mundo (100, 500 o 1000): ";
		cin >> tamano;
		cout << endl;
	}
	cout << "Ingrese la cantidad de dias que va a durar la simulacion: ";
	cin >> duracion;
	cout << endl;
	while (duracion <= 0)
	{
